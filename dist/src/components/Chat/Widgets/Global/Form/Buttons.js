...
var fun = function fun(_ref) {
  var content = _ref.content,
      ...
      optionsClass = _ref.optionsClass,
      TEMPLATE_TYPE = _ref.TEMPLATE_TYPE,
      MESSAGE_ID = _ref.MESSAGE_ID;
  var buttonsContent = [];
  var x = 0;

  var _iterator = _createForOfIteratorHelper(payloadData),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var button = _step.value;
      var buttonContent = /*#__PURE__*/(0, _react.createElement)(_Button.default, _objectSpread(_objectSpread({
        button: button
      }, props), {}, {
  ...
  content.push( /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
    className: "buttons" + optionsClass,
