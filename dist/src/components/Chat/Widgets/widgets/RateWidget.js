...
var RateWidget = function RateWidget(props) {
  var data = props.data,
      submit = props.submit,
  ...
  var defaultValue = JSON.parse(addGetLocalstorage(storageKey, null, "GET"));
  ...
  var confirm = function confirm() {
    ...
    submit("/".concat(data.attachment.payload.template_type).concat(JSON.stringify(payload)), rate);
  };
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    className: "rasa-rate-widget rasa-green rasa-custom-chat-box",
...
var _default = RateWidget;
exports.default = _default;

//# sourceMappingURL=RateWidget.jsx.map