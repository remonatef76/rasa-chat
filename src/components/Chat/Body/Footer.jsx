...
const Footer = () => {
    ...
    return (
        <div className="footer-container">
            <div className="up">
                <textarea className="rw-new-message rendered" placeholder="Type a message" name="message" type="text" value={message} 
            ...
            <div className="down">
                <div className="emojis-file">
                    <div className="emojis-picker-container">
                        <div className={`picker ${!emojiPicker ? 'hide-picker': ''}`}><Picker onEmojiClick={onEmojiClick} /></div>
